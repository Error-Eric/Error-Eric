...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:cutesmalle@foxmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}cutesmalle@foxmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+90-541-999-99-99}{{\footnotesize\faPhone*}\hspace*{0.13cm}+86 183 6749 2342}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                ...
                \item \textbf{Courses:} Chinese A Lit SL, English B HL, Environmental Science and Societies SL, Mathematics AA HL, Chemistry SL, Physics HL.
            \end{highlights}
        \end{twocolentry}
