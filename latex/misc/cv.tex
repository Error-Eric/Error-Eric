...
\begin{document}
    ...
    \section{Education Experience}
        \begin{twocolentry}{ Sept 2023 - May 2026 }
            ...
            \begin{highlights}
                \item \textbf{Predicted Grade}: 42/42. %(\href{https://example.com}{a link to somewhere})
    ...
    \begin{onecolentry}
        ...
        \textbf{Technical:} C++, Python, Java, \LaTeX

        \vspace{5pt}

        \textbf{Interests:} Drum set, table tennis, chess % Does this sound weird?
    \end{onecolentry}
