...
\subsection{Processed data} % More details should be included.
\label{sec.procd}
...
\begin{itemize}
    ...
    \item a y-intercept of $1.4557 \SI{}{s^2}$. % Should include the uncertainty and why it is so large. 
\end{itemize}

% Notes:
% That horizontal error bar is too small to be displayed in the graph.
