...
\begin{itemize}
    ...
    \item \textbf{String attaching} When attaching the wire to the axle, some hot-melt adhesive is used to ensure connection stability. This also contributed to inconsistant radius. Opt for an axle with a hole for attachment to avoid the use of hot-melt adhesive. 
\end{itemize}
